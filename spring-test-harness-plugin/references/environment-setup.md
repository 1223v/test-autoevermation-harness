...
| E2 | **MCP Python SDK** (`mcp[cli]>=1.2.0`) | `python3 -c "import mcp"` | auto | `AskUserQuestion("MCP SDK 설치할까요?")` → 예: `pip install -r mcp/requirements.txt` | **자동** `pip install -r mcp/requirements.txt` | policy #1 |
