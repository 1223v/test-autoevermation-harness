...
|---|---|---|
| "이 패키지/클래스만 다시" | 2(ast)→3→4→4.5→5→6→8→(9)→10 (대상 스코프 한정) | 01_spec |
| "스펙 문서 추가했어" | 1(spec)→4→4.5→5→6→8→(9)→10 | 02_ast, 03_source |
| "시나리오 다시/승인 다시" | 4(scenario)→4.5(승인)→5→6→8→(9)→10 | 01~03 |
...
| "시나리오 만족하는지만 확인" | 10(verify-scenarios) | 01~09, 04b |
