...
- `/test-autoevermation-harness-plugin:mutation-test` 스킬이 mutationScore 미달을 감지했을 때 호출
...
- `/test-autoevermation-harness-plugin:mutation-test` — 이 에이전트를 mutation score 미달 시 호출
- `/test-autoevermation-harness-plugin:full-pipeline` — 뮤테이션 루프에서 호출
